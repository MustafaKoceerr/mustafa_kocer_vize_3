...
class FilterActivity : AppCompatActivity() {
    ...
    btnBack.setOnClickListener {
        ...
        val mutableList = mutableListOf<String>("Kan Grubu Seçin","A-","A+","B-","B+","AB-","AB+","O+","O-")
        val arrayAdapter = ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, mutableList)
